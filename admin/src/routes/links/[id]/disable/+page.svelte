...
<svelte:head>
	<title>Disable link | aka</title>
</svelte:head>

<div class="container-sm">
	<div class="page-header">
		<div>
			<h1 class="page-title">Disable link</h1>
		</div>
	</div>
		...
		<form method="post">
			<div class="card">
				...
				<div class="card__body card__body--content">
					<p>Disabled links won't redirect users.</p>
					<p>They are still be preserved for analytics and can be re-enabled later.</p>
				</div>
